              ...
              <div className="mb-6 bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
                <div className="grid grid-cols-2">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center px-6 py-4 transition-all duration-200 font-medium cursor-pointer ${formData.danish_market === 1
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center px-6 py-4 transition-all duration-200 font-medium cursor-pointer ${formData.danish_market === 0
                        ? 'bg-sky-600 text-white shadow-xl ring-2 ring-sky-400 ring-opacity-50'
                        : 'bg-slate-700 text-slate-300 hover:bg-slate-600 hover:text-white'
                      }`}
                  >
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      max="2026"
                      required
                      className={`w-full bg-slate-950 border rounded px-3 py-2 text-slate-100 focus:outline-none focus:ring-1 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ${yearError
