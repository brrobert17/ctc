          ...
          <div className="relative p-[1px] rounded-2xl bg-gradient-to-r from-sky-500/30 via-slate-700 to-emerald-500/30 overflow-hidden">
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between gap-8 p-8 bg-slate-900 rounded-2xl backdrop-blur-xl">
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-white mb-4">How our price estimations works (in short)</h3>
                <ul className="space-y-3 text-slate-300 text-lg">
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-sky-400 rounded-full shadow-[0_0_10px_rgba(56,189,248,0.5)]"></div>
                    Trained on historical used car listings from the USA
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-sky-400 rounded-full shadow-[0_0_10px_rgba(56,189,248,0.5)]"></div>
                    The model can estimate car prices for both US and Danish market
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-sky-400 rounded-full shadow-[0_0_10px_rgba(56,189,248,0.5)]"></div>
                    For best results follow the guidance on the estimation page
                  </li>
                </ul>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={() => setShowModal(false)}>
          <div className="bg-slate-900 max-w-2xl w-full max-h-[90vh] overflow-y-auto rounded-xl border border-slate-700 shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4 text-slate-300 leading-relaxed">
              <p>
                Our pricing model is based on machine learning and is trained on historical used car listing data.
                It was trained on US car sales data dating back to 2003.
                The model estimates a car’s price by comparing it to similar vehicles in the dataset it was trained on.
              </p>

              <p>
                The model uses a fixed set of structured input features, including:
              </p>

              <ul className="list-disc pl-5 space-y-1 marker:text-sky-500">
                <li>
                  <strong>Manufacturer, model, and year:</strong> Define the general category and age of the vehicle.
                </li>
                <li>
                  <strong>Mileage:</strong> Higher mileage generally results in a lower estimated value.
                </li>
                <li>
                  <strong>Engine size, drivetrain, fuel type, horsepower, and transmission:</strong> Used as indicators of performance and vehicle class.
                </li>
                <li>
                  <strong>Ownership and usage:</strong> Information such as personal use and whether the car has had a single owner.
                </li>
                <li>
                  <strong>Accident and damage history:</strong> Known damage records that may impact the estimated value.
                </li>
              </ul>

              <p>
                When a car is labeled as <em>“Underpriced”</em>, it means that the listed price is notably lower than the model’s estimated price for similar vehicles based on the available data. The estimation is intended as a guideline only. Since the model relies solely on listed information, it cannot account for factors such as hidden mechanical issues, cosmetic damage, or individual vehicle condition.
              </p>
            </div>
